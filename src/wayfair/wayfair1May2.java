...
*/
        ...
        public static void main(String[] argv) {
            ...
            wayfair1May2.printUserMap(badgeTimes);
        }
        ...
        public static void printUserMap(String[][] badgeTimes) {
            ...
            for(int i = 0 ;i < badgeTimes.length;i++){
                if(hm.containsKey(badgeTimes[i][0])){
                    time = hm.get(badgeTimes[i][0]);
                    time.add(Integer.parseInt(badgeTimes[i][1]));
                    Collections.sort(time);
                    hm.put(badgeTimes[i][0], time);
                }
                else{
...
//            for(Map.Entry<String,ArrayList> hmm : hm.entrySet()){
//                time = hmm.getValue();
//                for(j = 1;j < time.size();j++){
//                    int hr = time.get(j) - time.get(0);
//                    if( hr < 0 || hr > 100 ){
//                        if(j >=3 ){
//                            time.remove(j);
//                            j--;
...
//                        }
//                    }
//                    hm.put(hmm.getKey(), time);
//                }
//            }
//
            for(Map.Entry<String, ArrayList> hmeach : hm.entrySet()){
